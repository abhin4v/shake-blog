...
All dependencies are managed automatically by [Magix](https://github.com/dschrempf/magix) via the shebang at the top of `blog.hs`. Magix uses Nix underneath to provision GHC and Haskell packages. There is no package manager or build tool to install.

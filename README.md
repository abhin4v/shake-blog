...
Shake Blog is a starter project for building your own static site generator using [Shake](https://shakebuild.com) and Haskell. It produces a blog with posts, standalone pages, tag archives, and an Atom feed of posts.
...
[Shake Blog's website](https://abhin4v.github.io/shake-blog/) is created using itself. The blogposts are the documentation and demonstration for the project. Read them and read their source code to get started with the project.

## Contributing

I don't foresee adding any new features to Shake Blog. It is meant to be forked and extended. I'll keep doing bugfixes, security fixes and dependency upgrades.
